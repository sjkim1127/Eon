...
impl StructureAnalysis {
    pub fn from_pillars(pillars: &FourPillars) -> Self {
        ...
        // 1. 건록격/양인격 우선 판정
        let stage = crate::twelve_stages::calculate_twelve_stage(dm, month_branch);
        if stage == crate::twelve_stages::TwelveStage::Jianlu {
            return Self {
        ...
        if stage == crate::twelve_stages::TwelveStage::Diwang && dm.polarity() == Polarity::Yang {
            return Self {
