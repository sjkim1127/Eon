...
use crate::relationships::RelationshipAnalysis;
...
impl DestinyItEasy {
    ...
    fn detect_file_type(pillars: &FourPillars) -> String {
        ...
        match analysis.strength_type {
            crate::strength::StrengthType::Strong => "Standalone Executable (신강)".to_string(),
            crate::strength::StrengthType::Weak => "Dependent Library (신약)".to_string(),
            crate::strength::StrengthType::Balanced => "Shared Object (중화)".to_string(),
        }
    }
}
