...
impl LifePathEmulator {
    ...
    pub fn emulate(&self) -> LifePathReport {
        ...
        for age in 0..=100 {
            ...
            let frame = self.vm.step(age, yearly_ganzi, major_ganzi);
            frames.push(frame);
        }
    ...
    fn get_major_at_age(&self, major: &crate::major_luck::MajorLuckAnalysis, age: u32) -> GanZi {
