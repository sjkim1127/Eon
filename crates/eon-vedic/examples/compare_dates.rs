...
fn main() {
    ...
    print_chart("2004-11-27 (User Input Date)", Utc.ymd(2004, 11, 27).and_hms(13, 0, 0));
    
    // Oct 27, 2004 13:00 UTC (22:00 KST)
    print_chart("2004-10-27 (Suspected Actual Date)", Utc.ymd(2004, 10, 27).and_hms(13, 0, 0));
}
