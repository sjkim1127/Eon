...
fn print_chart(date_str: &str, time: chrono::DateTime<Utc>) {
    ...
    println!(
        "ASC:  {:.2}° | Rasi: {} | Nak: {}",
        chart.ascendant.sidereal_deg, chart.ascendant.rasi, chart.ascendant.nakshatra
    );
    ...
    println!(
        "Sun:  {:.2}° | Rasi: {} | Nak: {}",
        sun.sidereal_deg, sun.rasi, sun.nakshatra
    );
    ...
    println!(
        "Moon: {:.2}° | Rasi: {} | Nak: {}",
        moon.sidereal_deg, moon.rasi, moon.nakshatra
    );
    ...
    println!(
        "Merc: {:.2}° | Rasi: {} | Nak: {}",
        merc.sidereal_deg, merc.rasi, merc.nakshatra
    );
}
...
fn main() {
    ...
    print_chart(
        "2004-11-27 (User Input Date)",
        Utc.with_ymd_and_hms(2004, 11, 27, 13, 0, 0).unwrap(),
    );

    // Oct 27, 2004 13:00 UTC (22:00 KST)
    print_chart(
        "2004-10-27 (Suspected Actual Date)",
        Utc.with_ymd_and_hms(2004, 10, 27, 13, 0, 0).unwrap(),
    );
}
