...
pub enum TK {
    ...
    ZwdsInnateSihua,
    ZwdsMinorStarDesc,
    ZwdsDetectedPatterns,
    ZwdsFlyingStars,
    ZwdsPalaceLifeReading,
    ZwdsOppositePalace,
    ZwdsTriadPalace,
    ZwdsDescPalaceMing,
    ZwdsDescPalaceXiongDi,
    ZwdsDescPalaceFuQi,
    ZwdsDescPalaceZiNv,
    ZwdsDescPalaceCaiBo,
    ZwdsDescPalaceJiE,
    ZwdsDescPalaceQianYi,
    ZwdsDescPalaceJiaoYou,
    ZwdsDescPalaceGuanLu,
    ZwdsDescPalaceTianZhai,
    ZwdsDescPalaceFuDe,
    ZwdsDescPalaceFuMu,
    ZwdsDescStarZiWei,
    ZwdsDescStarTianJi,
    ZwdsDescStarTaiYang,
    ZwdsDescStarWuQu,
    ZwdsDescStarTianTong,
    ZwdsDescStarLianZhen,
    ZwdsDescStarTianFu,
    ZwdsDescStarTaiYin,
    ZwdsDescStarTanLang,
    ZwdsDescStarJuMen,
    ZwdsDescStarTianXiang,
    ZwdsDescStarTianLiang,
    ZwdsDescStarQiSha,
    ZwdsDescStarPoJun,
    ZwdsDescStarWenChang,
    ZwdsDescStarWenQu,
    ZwdsDescStarZuoFu,
    ZwdsDescStarTianKui,
    ZwdsDescStarTianYue,
    ZwdsDescStarYouBi,
    ZwdsDescStarLuCun,
    ZwdsDescStarQingYang,
    ZwdsDescStarTuoLuo,
    ZwdsDescStarHuoXing,
    ZwdsDescStarLingXing,
    ZwdsDescStarDiKong,
    ZwdsDescStarDiJie,
    ...
    WestSignAquarius,
    WestSignPisces,
    WestAspectConjunction,
    WestAspectSextile,
    WestAspectSquare,
    WestAspectTrine,
    WestAspectOpposition,
    WestElementFire,
    WestElementEarth,
    WestElementAir,
    WestElementWater,
    WestModalityCardinal,
    WestModalityFixed,
    WestModalityMutable,
    ...
    IchingTiElement,
    IchingTiYongBiHe,
    IchingTiYongAnalysis,
    IchingSourceGood,
    IchingSeasonGood,
    IchingCurrentCycle,
    IchingYongControlsTi,
    IchingYongHelpsTi,
    IchingPostnatalLabel,
    IchingHorse,
    IchingLu,
    IchingCopyReport,
    IchingVoid,
    ...
    AiGroqIntegration,
    AiAnalysisTarget,
    AiSystemSecurityAudit,
    AiError,
    AiParseError,
    AiCommError,

    VedicDestinyOverview,
    VedicBirthChart,
    VedicVargasDetail,
    VargaInterpretations,
    VedicYogaAnalysisTitle,
    VedicDashaTimeline,
    VedicTransitTitle,
    VedicHouseEnergy,
    VedicPlanetScore,
    ...
    SajuMonthStem,
    SajuYearStem,
    SajuDirectionForward,
    SajuDirectionReverse,
    SajuStrengthTitle,
    SajuTenGodsPower,
    SajuFiveElementsPower,
    SajuHarmonyClashTitle,
    SajuSystemEngTitle,
    SajuFuzzerLoadTitle,
    SajuLintAdviceTitle,
    SajuAuxPillarsTitle,
    SajuStructurePatternTitle,
    SajuSpiritMarkersDetailTitle,
    SajuMajorLuckTimeline,
    SajuAmHarmonyDetailTitle,
    SajuVoidEmptinessTitle,
    SajuOriginalChartTitle,
    SajuHiddenStemsProjectionTitle,
    SajuPowerAnalysisTitle,
    SajuNoProjectedJijanggan,
    // ── Navigation ─────────────────────────────────────────────────────
    NavSaju,
    NavVedic,
    NavStrength,
...
pub fn translate_avastha(locale: Locale, av: &LajjitadiAvastha) -> &'static str {
    match locale {
        ...
        Locale::Zh => match av {
            ...
            LajjitadiAvastha::Trishita => "口渴 (Kshudhita)",
