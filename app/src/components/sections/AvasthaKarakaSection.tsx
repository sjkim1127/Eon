...
export function AvasthaKarakaSection({ avasthas, karakas }: AvasthaKarakaSectionProps) {
                                    ...
                                    return (
                                        <tr key={i} className="hover:bg-white/[0.03] transition-colors">
                                            ...
                                            <td className="py-2.5 pr-4">
                                                <span className={`text-xs px-2 py-0.5 rounded-full border font-semibold ${baladi.color}`}>
