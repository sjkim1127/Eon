...
- **Nakshatra Detailed Analysis**: Padas (1-4) and Tarabala calculations for granular timing.
- **Tajika (Annual Horoscope)**: Foundational logic for Muntha, Tajika aspects, and Ithasala yogas.

## 🖥 Desktop Application (Tauri)

The project includes a high-performance desktop application built with **Tauri v2** and **React**.

### Features

- **Glassmorphism UI**: A premium, modern interface with celestial themes.
- **Real-time Rust Integration**: High-speed astrological calculations using the core engine.
- **BPHS Compliant**: Precision analysis powered by the library's validated logic.
